            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-toolbar pull-right">
                        <div class="btn-group">
                            <a href="{!! URL::route('admin.pages.create') !!}" id="sample_editable_1_new"
                               class="btn blue">
                        ...
                        @foreach ($records as $key => $record)
                            <tr class="odd gradeX">
                                ...
                                <td class="center text-center">
                                    <a href="{!! URL::route('admin.pages.show', $record->id) !!}"
                                       class="btn btn-xs blue" title="Show Record">
                                        <i class="fa fa-search"></i>
                                    </a>
                                    <a href="{!! URL::route('admin.pages.edit', $record->id) !!}"
                                       class="btn btn-xs green" title="Edit">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    @if(in_array($record->id, $restrictedPages))
                                        <a class="btn btn-xs red" disabled href="javascript:;"
                                           data-title="Delete Record" title="Delete Record">
