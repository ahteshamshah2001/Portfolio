...
use App\Mail\BidReceivedEmail as BidReceivedMailable;
use Carbon\Carbon;
...
class BidSentNotification extends Notification
{
    use Queueable;
     ...
     * @param mixed $notifiable
     * @return BidReceivedMailable
     */
    public function toMail($notifiable)
    {
        return (new BidReceivedMailable(
            [
