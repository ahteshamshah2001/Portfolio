...
use App\Mail\InvoicePayEmail as InvoicePayMailable;
use Carbon\Carbon;
...
class InvoicePayNotification extends Notification
{
    use Queueable;
     ...
     *
     * @param  mixed  $notifiable
     * @return InvoicePayMailable
     */
    public function toMail($notifiable)
    {
        return (new InvoicePayMailable(
                [
