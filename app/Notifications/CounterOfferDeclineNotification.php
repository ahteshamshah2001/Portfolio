...
use App\Mail\CounterOfferDeclineEmail as CounterOfferDeclineMailable;
use Carbon\Carbon;
use Illuminate\Bus\Queueable;
use Illuminate\Notifications\Messages\BroadcastMessage;
use Illuminate\Notifications\Notification;

class CounterOfferDeclineNotification extends Notification
{
    use Queueable;
     ...
     *
     * @param mixed $notifiable
     * @return CounterOfferDeclineMailable
     */
    public function toMail($notifiable)
    {
        return (new CounterOfferDeclineMailable(
            [
